...
Проект направлен на создание интерпретируемой модели регрессии, способной **предсказывать рейтинг отеля** на основе текстовых и числовых признаков.  
Используется кастомная архитектура `HotelRegressor` на **PyTorch** с акцентом на:
...
Компания сталкивается с недобросовестными отелями, искусственно завышающими оценки.  
Цель — создать **предиктивную модель**, которая сможет объективно оценивать рейтинг отеля на основе доступных данных.  
Модель позволит:
